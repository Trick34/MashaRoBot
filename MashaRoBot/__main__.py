...
buttons = [
    [
        InlineKeyboardButton(
            text="✛𝘼𝘿𝘿 𝙏𝙊 𝙔𝙊𝙐𝙍 𝙂𝙍𝙊𝙐𝙋✛", url="t.me/Mr_Cosmic_bot?startgroup=true"),
    ],
    [
    ...
    [
        InlineKeyboardButton(
            text="×𝐒𝐔𝐏𝐏𝐎𝐑𝐓×", url=f"https://t.me/Mr_Cosmic_Support"
        ),
    ],
]
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text(
            "Hey I am Online since:</b> <code>{}</code>".format(
                uptime
            ),
    ...
    if query.data == "source_":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [ 
                   InlineKeyboardButton(text="Back🤧", callback_data="masha_"),
                    InlineKeyboardButton(text="Main Menu🌱", callback_data="source_back")
                 ]
                ]
            ),
        )
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "Cosmic is Back⚡")
        except Unauthorized:
            LOGGER.warning(
